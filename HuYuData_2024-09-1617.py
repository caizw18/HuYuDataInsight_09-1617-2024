...
# Fetch Amazon's current stock price
ticker = 'AMZN'
data = yf.Ticker(ticker)
current_price = data.history(period='1d')['Close'].iloc[-1]

# Parameters for the Black-Scholes model
S = current_price  # Current stock price of Amazon (AMZN)
K = 140  # Strike price (you can change this to any value)
...
# Print the results
print(f"Amazon (AMZN) Current Stock Price: {S:.2f}")
...
# Amazon (AMZN) Current Stock Price: 135.56
# Strike Price: 140
# Time to Expiration (years): 1.10
# Risk-Free Interest Rate: 0.05
# Volatility: 0.28
# Call Option Price: 10.45
# Put Option Price: 11.23